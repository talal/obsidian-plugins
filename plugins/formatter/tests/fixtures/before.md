...
This is the *main* project note for **Project Alpha**.  It links to [[Design Doc]] and embeds a diagram: ![[architecture.png]]
...
##  Overview
Project Alpha is a *cli tool* written in __Rust__.  It aims to be ~~slow~~ fast.
